...
import '../exams/exams_filter_data.dart';

class ExamsFilterPage extends StatefulWidget {
  final ExamsFilterData _filters;

  ExamsFilterPage({Key key, @required ExamsFilterData filters})
      : assert(filters != null),
        _filters = filters,
        super(key: key);

  @override
  _ExamsFilterPageState createState() => _ExamsFilterPageState(_filters);
}

class _ExamsFilterPageState extends State<ExamsFilterPage> {
  ExamsFilterData _filters;

  _ExamsFilterPageState(this._filters);
  ...
  List<Widget> _createFilterSections(
      BuildContext context, ExamsFilterData filters) {
