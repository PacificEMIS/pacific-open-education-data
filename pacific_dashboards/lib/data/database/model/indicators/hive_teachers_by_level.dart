...
part 'hive_teachers_by_level.g.dart';

@HiveType(typeId: 29)
class HiveTeachersByLevel extends HiveObject with Expirable {
  @HiveField(0)
  String year;
  ...
  IndicatorsTeacherByLevel toIndicatorsTeacherByLevel() => IndicatorsTeacherByLevel(
    year: year,
  ...
  static HiveTeachersByLevel from(IndicatorsTeacherByLevel sectorByLevel) => HiveTeachersByLevel()
