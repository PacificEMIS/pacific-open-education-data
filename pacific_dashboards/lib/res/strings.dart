...
class Strings {
  ...
  static Map<String, Map<String, String>> _localizedValuesDefault = {
    'en': {
      ...
      'downloadCountryData': 'Download country data for offline use',
      ...
      'examsDashboardsViewByBenchmarkAndGender': 'By Gender',
      ...
      'certifiedNotQualified': 'Certified (not qualified)',
      'all': 'Total',
      'qualified': 'Qualified',
      'certified': 'Certified',
      ...
      'downloadNote':
          'There is a large amount of data to download. To make sure that all data will be downloaded, press Download, keep your phone with screen on and stay at this page until download completes. This could take several minutes to complete even on a good Internet connection.',
      ...
      'updateCancel': 'CANCEL',
      'update': 'UPDATE',
      'achievementLevel1': 'Well below competent',
      'achievementLevel2': 'Approaching competence',
      'achievementLevel3': 'Minimally competent',
      'achievementLevel4': 'Competent',
      'achievementByGenderLabel': 'Achievement by Gender',
      'govtNonGovt': 'Govt / Non-govt',
      'govt': 'Government',
      'nonGovt': 'Non-government',
      'examShowMode': 'Type of measure',
      'examShowMode1': 'Candidate Count',
      'examShowMode2': 'Indicator Count',
      'examShowMode3': 'Weighted Indicator Count',
      'recordType': 'Record Type',
      'selectAll': 'Select all',
      'schools': 'Schools',
      'teachers': 'Teachers',
      'exams': 'Exams',
      'schoolAccreditations': 'School Accreditations',
      'budgets': 'Budgets',
