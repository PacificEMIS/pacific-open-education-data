...
class Strings {
  ...
  static Map<String, Map<String, String>> _localizedValuesDefault = {
    'en': {
      ...
      'washUsableGenderToilets': '% Usable (gender)',
      'washPupilsToilet': 'Pupils / toilet',
      'washPupilsToiletGender': 'Pupils / toilet (gender)',
      'washPupilsUsableToilet': 'Pupils / usable toilet',
      'washPupilsUsableToiletGender': 'Pupils / usable toilet (gender)',
      'washPupils': 'Pupils',
      'washPupilsMirrorFormat': 'Pupils (mirror format)',
